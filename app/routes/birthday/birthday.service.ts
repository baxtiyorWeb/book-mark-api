...
export const BirthdayService = {
	async get_dates(user_id: string, res: Response) {
		try {
	...
	async create_date(dto: CreateDateDto, user_id: string, res: Response) {
		try {
	...
	async delete_date(user_id: string, date_id: string, res: Response) {
		try {
